...
async function proxy(request: Request): Promise<Response> {
  try {
    ...
    // IMPORTANT: read body fully to avoid stream/duplex issues in fetch.
    // Use ArrayBuffer directly (avoid Buffer) for runtime compatibility.
